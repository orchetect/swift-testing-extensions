...
@Suite
struct TestResource_File_Tests_foo {
    @Test
    func resourceData() throws {
...
@Suite
struct TestResource_File_Tests_bar {
    @Test
    func resourceData() throws {
...
@Suite
struct TestResource_File_Tests_baz {
    ...
    @Test
    mutating func resourceData() throws {
