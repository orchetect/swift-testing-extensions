...
extension compression_algorithm {
    static var brotli: Self { COMPRESSION_BROTLI }
    static var lz4: Self { COMPRESSION_LZ4 }
    static var lz4Raw: Self { COMPRESSION_LZ4_RAW }
    static var lzbitmap: Self { COMPRESSION_LZBITMAP }
    static var lzfse: Self { COMPRESSION_LZFSE }
    static var lzma: Self { COMPRESSION_LZMA }
    static var zlib: Self { COMPRESSION_ZLIB }
}
